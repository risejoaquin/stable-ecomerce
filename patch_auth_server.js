...
// remove the old requireAuth definition
server = server.replace(
  "const requireAuth = () => (req: any, res: any, next: any) => { req.auth = { userId: 'dummy_user' }; next(); };\nconst mockAuthMiddleware = () => (req: any, res: any, next: any) => { req.auth = { userId: 'dummy_user' }; next(); };",
  ""
);
